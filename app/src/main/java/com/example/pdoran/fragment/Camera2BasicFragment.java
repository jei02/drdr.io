...
package com.example.pdoran.fragment;
...
import com.example.pdoran.view.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
     ...
     *카메라 전면 후면 아이디 값
     */
    private int facingId=0; //전면화면이 먼저 실행되도록..! 전면화면 = 0
    ...
    /**
     * Orientation of the camera senso
     */
